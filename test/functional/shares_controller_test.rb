...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { share_event: @share.share_event, share_photo: @share.share_photo, share_review: @share.share_review }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { share_event: @share.share_event, share_photo: @share.share_photo, share_review: @share.share_review }
    assert_redirected_to share_path(assigns(:share))
  end
