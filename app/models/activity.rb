...
#  belongs_to :review
  ...
  VALID_ACCESS = [CREATE_REVIEW, UPLOAD_PHOTO, VOTE_REVIEW, CHANGE_LOCATION, ADD_FAVORITE_PLACE, HAVE_NEW_FRIEND, CHANGE_PROFILE_PHOTO, ADD_VISITED_PLACE, CREATE_COMMENT, CREATE_EVENT]
